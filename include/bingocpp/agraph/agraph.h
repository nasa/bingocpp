...
typedef std::tuple<Eigen::ArrayX3i, Eigen::ArrayX3i, Eigen::ArrayXXd,
                   bool, double, bool, int, bool, bool>
    AGraphState;
...
namespace bingo
{
  ...
  public:
     ...
     */
    void SetLocalOptimizationParams(Eigen::ArrayXXd params);
     ...
     *
     * @return Eigen::ArrayXXd The constants in the AGraph
     */
    const Eigen::ArrayXXd &GetLocalOptimizationParams() const;
  ...
  private:
    ...
    Eigen::ArrayXXd simplified_constants_;
    bool needs_opt_;
    double fitness_;
    bool fit_set_;
    int genetic_age_;
