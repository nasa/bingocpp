 ...
 *  \fn void evaluate(const Eigen::ArrayX3i &stack,
 *                               const Eigen::ArrayXXd &x,
 *                               const Eigen::VectorXd &constants,
 *                               std::vector<Eigen::ArrayXXd> &buffer,
 *                               std::size_t result_location)
 *  \fn virtual void deriv_evaluate(Eigen::ArrayX3i &stack,
...
class Operation {
 public:
   ...
   *
   *  \param[in] stack The stack that contains each command. Eigen::ArrayX3i
   ...
   */
  virtual void evaluate(const Eigen::ArrayX3i &stack,
                        const Eigen::ArrayXXd &x,
                        const Eigen::VectorXd &constants,
                        std::vector<Eigen::ArrayXXd> &buffer,
   ...
   */
  // TODO - Pass in 2 int params instead of Eigen::ArrayX3i
  virtual void deriv_evaluate(const Eigen::ArrayX3i &stack,
                              const int command_index,
                              const std::vector<Eigen::ArrayXXd> &forward_buffer,
                              std::vector<Eigen::ArrayXXd> &reverse_buffer,
                              int dependency) = 0;
