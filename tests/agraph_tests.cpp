...
namespace
{
  ...
  TEST_F(AGraphTest, copy)
  {
    ...
    ASSERT_DOUBLE_EQ(agraph_copy.GetLocalOptimizationParams()(0, 0), 1.0);
  }
  ...
  TEST_F(AGraphTest, dump_load)
  {
    ...
    ASSERT_DOUBLE_EQ(agraph_copy.GetLocalOptimizationParams()(0, 0),
                     sample_agraph_1.GetLocalOptimizationParams()(0, 0));
    ASSERT_DOUBLE_EQ(agraph_copy.GetFitness(), sample_agraph_1.GetFitness());
    ASSERT_TRUE((agraph_copy.GetCommandArray() ==
                 sample_agraph_1.GetCommandArray())
                    .all());
  }
  ...
  INSTANTIATE_TEST_CASE_P(, AGraphTest, ::testing::Values("all_funcs_graph", "sample_agraph_1"));
