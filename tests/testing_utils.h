#ifndef BINGO_TESTS_TESTING_UTILS_H_
#define BINGO_TESTS_TESTING_UTILS_H_
...
namespace testutils {
  ...
  bool almost_equal(const Eigen::ArrayXXd &array1, const Eigen::ArrayXXd &array2) {
...
#endif // BINGO_TESTS_TESTING_UTILS_H_
